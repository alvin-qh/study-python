...
from execution.middleware import ModificationMiddleware, schema
...
def timeit_middleware(
    next: Callable, instance: Any, info: ResolveInfo, **kwargs
) -> Any:
    """
    ...
    # 获取当前实体的类型
    type_name = instance._meta.name if instance and hasattr(instance, "_meta") else ""
