...
from mongoengine import (Document, QuerySet, Q, signals)
...
class TenantAwareQuerySet(QuerySet):
    def __init__(self, doc: Type[Document], collection: Collection) -> None:
...
def _set_document_audited(doc_cls: Type[Document], document: Document, *args: Any, **kwargs: Any) -> None:
...
def _set_document_tenant(doc_cls: Type[Document], document: Document, *args: Any, **kwargs: Any) -> None:
