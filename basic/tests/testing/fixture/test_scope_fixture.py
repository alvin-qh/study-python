...
def function_scope_fixture() -> str:
    ...
    表示所有的测试函数 (包括测试类方法) 在执行前会执行一次该 `fixture`, 测试类中的方法无法通过参数访问到这类 `fixture`
...
def class_scope_fixture() -> str:
    ...
    表示所有的测试函数和测试类中的测试方法在执行前会执行一次该`fixture`. 所有的测试函数和测试类中的方法均能通过参数访问到这类 `fixture`
...
def module_scope_fixture() -> str:
    ...
    每个模块会执行一次, 所有的测试函数和测试类中的方法均能通过参数访问到这类 `fixture`
...
def session_scope_fixture() -> str:
    ...
    每次测试只会执行一次. 所有的测试函数和测试类中的方法均能通过参数访问到这类 `fixture`
...
def test_function_scope(
    ...
    """在测试函数内, 可以访问 `"session"`, `"module"`, `"class"` 以及 `"function"` 所有范围内的 `fixture`
...
class TestScope:
    ...
    def test_class_scope(
        ...
        """在测试函数内, 可以访问 `"function"`, `"session"`, `"module"`以及 `"class"` 范围内的 `fixture`
